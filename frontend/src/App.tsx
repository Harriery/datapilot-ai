...
function App() {
  ...
  const ui = {
    en: {
      greeting: "Good morning 👋", attention: "Here’s what needs your attention today.", workspaces: "WORKSPACES", yourWorkspaces: "Your workspaces", active: "active", loadingWorkspaces: "Loading workspaces...", noWorkspaces: "No workspaces yet.", noBrief: "No task brief added yet.", personal: "Personal", work: "Work", openWorkspace: "Open workspace →", deleting: "Deleting...", delete: "Delete", recommendation: "Current Recommendation", loadingRecommendation: "Loading recommendation...", priority: "priority", noRecommendation: "No practice recommendation right now.", todayPath: "Today’s path", loadingPath: "Loading path...", noActiveWorkspace: "No active workspace.", projectGoal: "PROJECT GOAL", developmentRowsFrom: "development rows from", sourceRows: "source rows", fullDataset: "Full dataset", rows: "rows", immutableSource: "Raw source remains unchanged and is used again when the pipeline is applied to the full dataset.", rawPreview: "Raw source preview", rawPreviewDescription: "The full raw source is preserved, but only a small paginated preview is sent to the browser. Workbench uses the development dataset shown above.", addTransformation: "+ Add transformation", loadingWorking: "Loading working dataset...", workingSample: "Working dataset sample", workingDescription: "Click a column name to prepare a safe Workbench transformation." },
    nl: {
